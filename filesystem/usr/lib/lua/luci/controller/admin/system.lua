...
function index()
	...
	entry({"admin", "system"}, alias("admin", "system", "system"), _("System"), 30).sysauth = {"admin"}
...
function action_flashops()
	...
	-- stop wsmand and dxe-agent to free memory for the uploading space of the FW
	...
	local image_tmp   = "/tmp/shm/firmware.img"
